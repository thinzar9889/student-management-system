                                ...
                                @foreach($teachers as $teacher)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('teachers.edit', $teacher->id) }}" title="Edit Teacher"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
